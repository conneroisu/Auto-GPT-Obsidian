...
"""Import the partial frorm functools"""
from functools import partial

"""Mock Unit Test Package for testing in mock states"""
from unittest.mock import mock_open, patch

"""Import the git rerpository object from `GitPython` to do git operation"""
...
def ObsidianVaultTest(unittest.TestCase): 
    ...
    @patch.dict(
        os.environ,
        {
            ...
            "OBSIDIAN_FLASHCARD_SUBDIRECTORY" : "flashcards", 
            "OBSIDIAN_GITHUB_USERNAME" : "conneroisu",
    ...
    def test_construction_empty(self):  
        # Constructing a Vault using public empty vault example should have 0 items as contents
        empty_vault_url = "https://github.com/conneroisu/Empty-Obsidian-Vault-AutoGPT"   
        empty_vault = Obsidian_Vault()         
        assert len(empty_vault.content) == 0
    ...
    class Test_Red_Black_Tree(unittest.TestCase): 
